...
# Calculate the mean of the means (+sd) and the mean of the sd (by site)
sapply(tairAgg, mean, na.rm=TRUE) # -1.814 snowcovered and 11.167 snow-free
sapply(tairAgg, sd, na.rm=TRUE) # 1.701 and 1.435
sapply(tairSdAgg, mean, na.rm=TRUE) # 0.712 and 0.847
