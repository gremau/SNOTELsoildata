...
headertext = {['Generated by testfiles.m script on ' date]; ...
    'site_id, year'};
dlmwrite([datapath 'excludefiles.txt'], char(headertext), 'delimiter', '');
dlmwrite([datapath 'excludefiles.txt'], excludefiles, '-append');
